      ...
      <div className="p-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-2">Anasayfa içeriğini düzenleyin</p>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <select
              ...
              className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#b2d6a1] focus:border-transparent bg-white"
            >
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <h3 className="font-medium text-gray-900">İstatistik 1</h3>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Sayı
                      </label>
                  ...
                  <div className="space-y-4">
                    <h3 className="font-medium text-gray-900">İstatistik 2</h3>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Sayı
                      </label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <h3 className="font-medium text-gray-900">Buton 1</h3>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Metin
                      </label>
                  ...
                  <div className="space-y-4">
                    <h3 className="font-medium text-gray-900">Buton 2</h3>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Metin
                      </label>
