// app/admin/procedures/sac-ekimi/page.tsx
"use client";
...
export default function SacEkimiAdmin() {
  ...
  const loadPageData = useCallback(async () => {
    try {
      const res = await fetch(
        `/api/admin/procedures/sac-ekimi?locale=${locale}`
      );
      if (res.ok) {
  ...
  const loadFeatures = useCallback(async () => {
    try {
      const res = await fetch(
        `/api/admin/procedures/sac-ekimi/features?locale=${locale}`
      );
      if (res.ok) {
        const data = await res.json();
        setFeatures(data);
  ...
  const loadDeviceItems = useCallback(async () => {
    try {
      const res = await fetch(
        `/api/admin/procedures/sac-ekimi/device-items?locale=${locale}`
      );
      if (res.ok) {
        const data = await res.json();
        setDeviceItems(data);
  ...
  const loadTreatmentAreas = useCallback(async () => {
    try {
      const res = await fetch(
        `/api/admin/procedures/sac-ekimi/treatment-areas?locale=${locale}`
      );
      if (res.ok) {
        const data = await res.json();
  ...
  const loadPricing = useCallback(async () => {
    try {
      const res = await fetch(
        `/api/admin/procedures/sac-ekimi/pricing?locale=${locale}`
      );
      if (res.ok) {
        const data = await res.json();
        setPricing(data);
  ...
  const loadWhyUs = useCallback(async () => {
    try {
      const res = await fetch(
        `/api/admin/procedures/sac-ekimi/why-us?locale=${locale}`
      );
      if (res.ok) {
        const data = await res.json();
        setWhyUs(data);
  ...
  const loadFAQs = useCallback(async () => {
    try {
      const res = await fetch(
        `/api/admin/procedures/sac-ekimi/faqs?locale=${locale}`
      );
      if (res.ok) {
        const data = await res.json();
        setFaqs(data);
  ...
  const savePageData = async () => {
    ...
    try {
      const res = await fetch("/api/admin/procedures/sac-ekimi", {
        method: "PUT",
  ...
  const addFeature = async () => {
    ...
    const res = await fetch("/api/admin/procedures/sac-ekimi/features", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const addDeviceItem = async (type: "feature" | "advantage") => {
    ...
    const res = await fetch("/api/admin/procedures/sac-ekimi/device-items", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const addTreatmentArea = async () => {
    ...
    const res = await fetch("/api/admin/procedures/sac-ekimi/treatment-areas", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const addPricing = async () => {
    ...
    const res = await fetch("/api/admin/procedures/sac-ekimi/pricing", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const addWhyUs = async () => {
    ...
    const res = await fetch("/api/admin/procedures/sac-ekimi/why-us", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const addFAQ = async () => {
    ...
    const res = await fetch("/api/admin/procedures/sac-ekimi/faqs", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
    ...
    <ProtectedPage>
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto p-6 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Saç ekimi sayfasının içeriğini buradan yönetebilirsiniz
                </p>
              </div>
          ...
          {/* Tabs - Aynı yapı Saç Ekimi gibi devam eder... */}
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        Saç Ekimi uygulanabilecek bölgeler
                      </p>
                    </div>
                    <button
