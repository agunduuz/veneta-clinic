...
const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    comment:
      "Veneta Klinik'te geçirdiğim burun estetiği ameliyatından çok memnun kaldım. Doğal ve dengeli bir görünüm elde ettim. Tüm ekip çok profesyonel ve destekleyiciydi.",
  },
  {
    id: 2,
    name: 'Mehmet Demir',
    ...
    rating: 5,
    comment:
      "Diyet ve egzersizle gitmeyen inatçı yağlardan kurtulmak için Veneta Klinik'i tercih ettim. Sonuçlar beklediğimden de iyi, iyileşme süreci çok rahat geçti.",
  },
  {
    id: 3,
    name: 'Zeynep Kaya',
    ...
    rating: 5,
    comment:
      'Doğal ve taze bir görünüm elde ettim. Uzman ekibin profesyonel yaklaşımı ve işlem sonrası takibi mükemmeldi.',
  },
];
      ...
      >
        <div className='text-center mb-8'>
          ...
          <p className='text-muted-foreground max-w-2xl mx-auto'>
            Hastalarımızın deneyimlerini ve sonuçlarını dinleyin
          </p>
        </div>
