...
const features = [
  {
    ...
    description:
      'We perform aesthetic treatments with the latest technological devices and methods. Our goal is to provide accurate diagnosis, effective treatment, and patient comfort.',
    image:
  ...
  },
  {
    ...
    title: 'Expert Team',
    description:
      'With our expert doctors and experienced team, we create personalized treatment plans and aim to achieve the best results for you.',
    image:
  ...
  },
  {
    ...
    description:
      'Our clinic provides personalized care services. Our team specializes in creating customized treatment plans after detailed examinations and consultations.',
    image:
      'https://images.unsplash.com/photo-1629909613654-28e377c37b09?q=80&w=1000',
  },
];

const AboutFeaturesEnglish = () => {
  return (
      ...
      <div className='relative w-full max-w-7xl mx-auto px-4'>
        ...
        >
          ...
          <p className='text-lg md:text-xl text-muted-foreground'>
            We provide you with the best experience with modern
            technology and our expert staff
          </p>
        </motion.div>
...
export default AboutFeaturesEnglish;
