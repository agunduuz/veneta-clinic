// components/Header/WhatsAppButton.tsx
"use client";
...
const WhatsAppButton = () => {
  ...
  const handleWhatsAppClick = () => {
    const phoneNumber = "+905309153488";
    const message = t("common.cta.whatsappMessage");
  ...
  return (
    <motion.button
      ...
      aria-label={t("common.cta.whatsappTooltip")}
    >
      <svg
        className="w-6 h-6"
        fill="currentColor"
