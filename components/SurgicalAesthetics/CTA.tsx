...
export default function CTA() {
  ...
  return (
    <div className="bg-gradient-to-r from-primary to-primary/80 rounded-2xl p-8 text-center text-primary-foreground animate-fade-in">
      {/* Title */}
      <h2 className="mb-4">{t("surgicalAesthetics.cta.title")}</h2>

      {/* Description */}
      <p className="text-lg mb-8 opacity-90">
        {t("surgicalAesthetics.cta.description")}
      </p>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        >
          ...
          {t("surgicalAesthetics.cta.ctaPhone")}
        </Link>
        ...
        >
          ...
          {t("surgicalAesthetics.cta.ctaWhatsApp")}
        </Link>
      </div>
    </div>
  );
